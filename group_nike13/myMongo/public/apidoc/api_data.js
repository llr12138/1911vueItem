define({ "api": [
  ...
  {
    "type": "post",
    "url": "/api/order/updatepaystatus",
    "title": "修改订单付款方式和付款状态",
    "description": "<p>修改订单的状态</p>",
    "name": "_api_order_updatepaystatus",
    "group": "order",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:3000/api/order/updatepaystatus"
      }
    ],
    "version": "1.0.0",
    "filename": "api/order.js",
  ...
  },
  {
    ...
    "title": "注册接口1",
    "description": "<p>注册接口1</p>",
    "name": "_api_users_register1",
    "group": "users",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:3000/api/users/register1"
      }
    ],
    "version": "1.0.0",
    "filename": "api/users.js",
  ...
  {
    "type": "get",
    "url": "/api/users/sendCode2",
    "title": "发送短信验证码2",
    "description": "<p>发送短信验证码2</p>",
    "name": "_api_users_sendCode2",
    "group": "users",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:3000/api/users/sendCode2"
      }
    ],
    "version": "1.0.0",
    "filename": "api/users.js",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "password",
            "description": "<p>密码 //  * @apiParam {number} sex 性别 （1 表示男  0 表示女） //  * @apiParam {string} email 邮箱</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/api/users/update2",
    "title": "修改个人中心2",
    "description": "<p>修改个人中心2</p>",
    "name": "_api_users_update2",
    "group": "users",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:3000/api/users/update2"
      }
    ],
    "version": "1.0.0",
    "filename": "api/users.js",
